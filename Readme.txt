...
4. For running our model, go to main.ipynb run it sequentially don't run the arduino control block as it would generate error rather run the input block where you have to give the temp.,humidity, precipitation.
